...
<template>
    ...
    <div class="container whitecontainer section">
        <h2 class="title">How we manage your data</h2>    

                    <p>We set the following category of cookies;</p>
                   

                    <h4 class="subtitle">XSRF cookies</h4>
                    <p>
                        These cookies are set as a security measure. They are a nececary measure to reduce the liklehood of a type of cyberattack called a Cross-site request forgery. You can read more about what XSRF is <a href="https://en.wikipedia.org/wiki/Cross-site_request_forge">here</a>. You are not identifiable from this cookie as it is pseudonymous. This cookie is vital to the safe functioning of this site. It is not possible to use this site without this cookie. As such, this cookie cannot be rejected and will still be set even if you click the reject cookies button. If this cookie is not present, our server will reject your connection to our website. This is a transient cookie and will be erased once you leave this site.
                    </p>

                    <br><br>
                    
                    <h4 class="subtitle">Session Cookies and session variables</h4>
                    <p>
                    ...
                    <h4 class="subtitle">Analytics Cookies</h4>
                    <p>
                    ...
                    <h4 class="subtitle">General data management</h4>
                    <p>
