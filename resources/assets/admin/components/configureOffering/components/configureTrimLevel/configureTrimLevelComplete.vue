            ...
            <div class="column is-4">
                ...
                <a class="button is-info is-outlined" @click="newFileModalOpen=true">+ Add new file</a>
                 ...
                 <table class="table is-striped is-fullwidth">
                    ...
                    <tbody>
                        <tr v-for="doc in imported.trimToEdit.files">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            fileDeleted(target){
                this.imported.trimToEdit.files=_.reject(this.imported.trimToEdit.files, ['id', target]);
                this.saveSuccessful;
            },
            deleteFile(target){
            ...
            fileUploaded(newFile){
                this.imported.trimToEdit.files.push(newFile);               
