...
<template>
	...
	<div class="tile is-parent pointer"  @click="$emit('chosenTrimLevelToEdit',info);">

	    <article 
	    	class="tile is-child notification pointer is-info box is-4by3 is-4 nosquash" 
		...
		<article class="tile is-child notification box">
			...
			<p class="subtitle">{{ data.comparison }}</p>
			<a v-if="data.id != imported.modelToEdit.id" class="button is-pulled-right" href="#editarea" v-smooth-scroll="{ duration: 1500}">Edit ></a>
		</article>
